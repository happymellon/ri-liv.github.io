<?php
	...
	$encryption_key		= 'riliv';			// Unique 8 to 32 character encryption key
	$notification_email	= 'victoriarxli@gmail.com';	// E-mail for notification of new comments
	$admin_nickname		= 'Victoria';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'Tea30Snow';			// Password to gain admin rights
